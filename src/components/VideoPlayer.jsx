			...
			<div ref={domNode} className="container">
				<div className="m-2 flex flex-wrap justify-center">
					<div className="w-full ">
						<div className="relative z-20 h-[250px] overflow-hidden rounded-lg md:h-[250px]">
							...
							<div
								className={`bg-primary absolute left-0 top-0 z-10 flex h-full w-full items-center justify-center bg-opacity-90`}
							>
								<button
									onClick={() => {
										setvideoOpen(true)
									}}
									className="text-primary absolute z-20 flex h-20 w-20 items-center justify-center rounded-full bg-white md:h-[100px] md:w-[100px]"
								>
			...
			{videoOpen && (
				<div className="fixed left-0 top-0 z-50 flex h-screen w-full items-center justify-center bg-black bg-opacity-70">
					...
					<button
						...
						className="text-body-color absolute right-0 top-0 flex h-20 w-20 cursor-pointer items-center justify-center hover:bg-black"
					>
